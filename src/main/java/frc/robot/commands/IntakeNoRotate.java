...
public class IntakeNoRotate extends Command {
  ...
  public IntakeNoRotate(ElevatorSubsystem Elevator_Subsystem, GrabberSubsystem Grabber_Subsystem, IntakeOutputSubsystem IntakeOutput_Subsystem) {
